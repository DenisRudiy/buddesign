          ...
          <div className="technics__technics">
            <div className="technics__content">
              ...
              <p className="technics__text">
                Наша компанія спеціалізується на постачанні різноманітної вторсировини для виробництва та переробки.
                Наші матеріали відповідають всім стандартам якості та екологічним вимогам, що робить нас надійним
                постачальником для вашого бізнесу.
              </p>
