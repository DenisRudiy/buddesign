  ...
  return (
    <>
      ...
      <section className="page_gallery_technics">
        <h2 className="page_gallery_technics_-title title-big">ЕКСКАВАТОРИ</h2>
                  ...
                  <div className="card_technics">
                    <div className="cover_technics card-image_technics">
                      <div className="content_technics">
                        ...
                        <h3 className="products__gallery__item_price_technics">
                          $ {item.price} <span className="products__span">| год</span>
                        </h3>
                    ...
                    <div className="cover_technics card-info_technics">
                      <div className="content_technics">
                        ...
                        <p className="mass_technics">
                          {" "}
                          Маса: <span className="products__span">{item.weight} т</span>
                        </p>
                        <p className="volime_technics">
                          {" "}
                          Об'єм ковша: <span className="products__span">{item.obem}м3</span>
                        </p>
                        <p className="depth_technics">
                          {" "}
                          Глибина копання: <span className="products__span">{item.deep} м</span>
                        </p>
